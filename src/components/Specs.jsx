      ...
      <div className="screen-max-width">
        ...
        <div className="flex flex-col items-center">
          <h2 className="hiw-title">
            A17 Pro chip. <br />A monster made for gaming.
          </h2>
        ...
        <div className="hiw-text-container">
          <div className="flex flex-1 justify-center flex-col">
            <p className="hiw-text g_fadeIn">
              A17 Pro is our entirely new class of iPhone chip that delivers our{" "}
          ...
          <div className="flex-1 flex-center">
            <p className="feature-text g_fadeIn">
              ...
              characters. With industry-leading speed and efficiency, A17 Pro
